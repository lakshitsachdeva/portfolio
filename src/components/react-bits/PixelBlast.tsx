...
float vnoise(vec3 p){
  ...
  float n010 = hash11(dot(ip + vec3(0.0,0.0,0.0), vec3(1.0,57.0,113.0)));
...
const PixelBlast = ({
  ...
  useEffect(() => {
    ...
    antialias, liquid, noiseAmount, pixelSize, patternScale, patternDensity, enableRipples, rippleIntensityScale, rippleThickness, rippleSpeed, pixelSizeJitter, edgeFade, transparent,
